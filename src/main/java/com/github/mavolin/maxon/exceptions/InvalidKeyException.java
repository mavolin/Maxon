...
public class InvalidKeyException extends RuntimeException {
    ...
    /**
     * Constructs a new {@code InvalidKeyException} with the specified detail message. The cause is not
     * initialized, and may subsequently be initialized by a call to {@link #initCause}.
     *
     * @param message
    ...
    /**
     * Constructs a new {@code InvalidKeyException} with the specified detail message and cause. <p>Note that
    ...
    /**
     * Constructs a new {@code InvalidKeyException} with the specified cause and a detail message of {@code
    ...
    /**
     * Constructs a new {@code InvalidKeyException} with the specified detail message, cause, suppression
