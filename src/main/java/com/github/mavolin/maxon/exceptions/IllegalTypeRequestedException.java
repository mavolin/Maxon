...
public class IllegalTypeRequestedException extends RuntimeException {
    ...
    /**
     * Constructs a new {@code IllegalTypeRequestedException} with the specified detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     *
     * @param message
    ...
    /**
     * Constructs a new {@code IllegalTypeRequestedException} with the specified detail message and cause.  <p>Note that the detail message
    ...
    /**
     * Constructs a new {@code IllegalTypeRequestedException} with the specified cause and a detail message of {@code (cause==null ? null :
    ...
    /**
     * Constructs a new {@code IllegalTypeRequestedException} with the specified detail message, cause, suppression enabled or disabled, and
